...
int main(int argc, char** argv)
{
    ...
    cout<<"TOTAL NUMBER OF TAG COMPARISONS: "<<cnt<<endl;
    float overhead = (cnt*(1.0)) / (accesses*(1.0));
    cout<<"OVERHEAD: "<<overhead<<endl;
    cout<<"********************************************************************************************************************************************************************************************************************************"<<endl;
    cout<<"SETS CLASSIFIED VERY HOT: "<<endl;
    cout<<"->";
    for(auto it:very_hot)
    {
        cout<<it<<", ";
    }
    cout<<endl;
    cout<<"SETS CLASSIFIED HOT: "<<endl;
    cout<<"->";
    for(auto it:hot)
    {
        cout<<it<<", ";
    ...
    cout<<endl;
    cout<<"SETS CLASSIFIED COLD: "<<endl;
    cout<<"->";
    for(auto it:cold)
    {
        cout<<it<<", ";
    ...
    cout<<endl;
    cout<<"SETS CLASSIFIED VERY COLD: "<<endl;
    cout<<"->";
